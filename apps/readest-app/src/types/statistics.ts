...
// Version history:
// 1: Initial version (had UTC timezone bug in date calculations)
// 2: Fixed to use local timezone for all date/time calculations
export const CURRENT_STATISTICS_VERSION = 2;

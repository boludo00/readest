...
const BookSessionTracker: React.FC<BookSessionTrackerProps> = ({ bookKey }) => {
  ...
  const { pushSessions, isAuthenticated } = useStatisticsSync();
  ...
  }, [bookKey, bookId, config.trackingEnabled, loaded, viewState?.inited, bookData?.book, progress?.pageinfo, startSession]);
  ...
  }, [bookKey, config.trackingEnabled, loaded, progress?.pageinfo, endSession, saveStatistics, envConfig, IDLE_TIMEOUT_MS, isAuthenticated, addPendingSyncSession, pushSessions]);
  ...
  }, [bookKey, bookId, config.trackingEnabled, loaded, endSession, startSession, saveStatistics, envConfig, isAuthenticated, addPendingSyncSession, pushSessions]);
  ...
  }, [bookKey, endSession, saveStatistics, envConfig, isAuthenticated, addPendingSyncSession, pushSessions]);
